...
export function Sequel() {
  ...
  return (
    <div className="fade-in" style={{ padding: pad, maxWidth: 1020 }}>
        ...
        {draft.beats.map((b, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              padding: '16px 18px', display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6, minWidth: 240, flex: 1 }}>
                ...
                <input
                  ...
                  style={{ fontFamily: 'Spectral, serif', fontSize: 18, lineHeight: 1.45, color: '#f0eee9', background: 'transparent', border: 0, padding: 0, borderRadius: 0 }}
                />
                <input
                  value={b.consequence}
                  onChange={(e) => patch({ beats: draft.beats.map((x, j) => (j === i ? { ...x, consequence: e.target.value } : x)) })}
                  style={{ fontSize: 12.5, color: 'rgba(236,234,230,0.5)', lineHeight: 1.5, background: 'transparent', border: 0, padding: 0, borderRadius: 0 }}
                />
              </div>
              <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <button className="btn-quiet" style={{ fontSize: 11, padding: '4px 4px' }}
      ...
      {/* gap + returning */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(282px, 1fr))', gap: 15, marginBottom: 30 }}>
        <div className="glass" style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 15 }}>
        ...
        <div className="glass" style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 11 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap', paddingTop: 6 }}>
          <button
            className="btn-primary" style={{ padding: '12px 22px', fontSize: 13.5 }}
            disabled={busy !== null || !draft.premise.trim()}
            onClick={() => void run('begin', async () => {
          ...
          <button
            className="btn-ghost"
            disabled={busy !== null}
            onClick={() => void run('premise', async () => {
