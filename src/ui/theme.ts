...
export const MOODS: Record<MoodId, { label: string; tint: string; text: string; accent: string; prose: string }> = {
  ...
  dusk:  { label: 'Dusk',  tint: 'rgba(130,125,145,0.11)', text: '#eeeaf2', accent: 'oklch(0.68 0.035 295)', prose: '#e4e0ea' },
  bloom: { label: 'Bloom', tint: 'rgba(165,175,130,0.1)', text: '#f0f2e8', accent: 'oklch(0.74 0.05 115)', prose: '#e6eadc' },
  storm: { label: 'Storm', tint: 'rgba(110,130,155,0.12)', text: '#e8edf2', accent: 'oklch(0.66 0.04 240)', prose: '#dce4ec' },
  brine: { label: 'Brine', tint: 'rgba(110,165,160,0.1)', text: '#e6f2f0', accent: 'oklch(0.72 0.05 185)', prose: '#d8eae6' }
};
